...
class DiarizationService:
    ...
    def load(self):
        ...
        self.pipeline._model.embedding_batch_size = 4
        self.pipeline._model.segmentation_batch_size = 4
    ...
    def diarize(self, audio_path: str, num_speaker: int | None = None) -> Iterable[DiarizationSegment]:
        ...
        # load audio into ram
        wave_from, sample_rate = torchaudio.load(audio_path)
        segments = self.pipeline({"waveform": wave_from, "sample_rate": sample_rate}, num_speakers=num_speaker)
